module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            dist: {
                src: [
                    '<%= DEV_DIR %>/js/vendor/jquery-1.11.1.js',
                    '<%= DEV_DIR %>/js/vendor/bootstrap.js',
                    '<%= DEV_DIR %>/js/core/main.js'
                ],
                dest: "<%= TEMP_DIR %>/aggregate.js"
            }
        },
    ...
    //compiling
    grunt.registerTask('dist', ['clean:dist', 'compass', 'copy:assets', 'cssmin:minify', 'concat:dist', 'uglify:dist', 'processhtml:dist']);
